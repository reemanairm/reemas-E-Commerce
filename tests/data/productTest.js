...
describe('test suite: Product', () => {
  ...
  it('gets the stars url', () => {
    expect(product.getStars()).toEqual('images/ratings/rating-45.png');
  });
...
describe('test suite: Clothing', () => {
  ...
  it('gets the stars url', () => {
    expect(clothing.getStars()).toEqual('images/ratings/rating-45.png');
  });
...
describe('test suite: Appliance', () => {
  ...
  it('gets the stars url', () => {
    expect(appliance.getStars()).toEqual('images/ratings/rating-50.png');
  });
